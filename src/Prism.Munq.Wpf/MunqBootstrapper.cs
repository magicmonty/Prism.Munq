...
namespace Prism.Munq
{
    ...
    public abstract class MunqBootstrapper : Bootstrapper
    {
        ...
        /// <summary>
        /// Gets the default <see cref="IIocContainer"/> for the application.
        /// </summary>
        /// <value>The default <see cref="IIocContainer"/> instance.</value>
        ...
        /// <summary>
        /// Configures the <see cref="IIocContainer"/>. May be overwritten in a derived class to add specific
        ...
        protected void RegisterTypeIfMissing<TFrom>([NotNull] Func<IDependencyResolver, TFrom> factory, bool registerAsSingleton) where TFrom: class
        {
            ...
            else
            {
                ...
                {
                    Container.Register(factory)?.AsContainerSingleton();
                }
                else
                {
